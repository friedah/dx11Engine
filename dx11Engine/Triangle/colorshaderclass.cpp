	...
	const XMMATRIX& projectionMatrix, ID3D11ShaderResourceView* texture)
{
	...
	XMMATRIX worldMatrixTran = XMMatrixTranspose(worldMatrix);
	XMMATRIX viewMatrixTran = XMMatrixTranspose(viewMatrix);
	XMMATRIX projectionMatrixTran = XMMatrixTranspose(projectionMatrix);
    ...
    dataPtr->world = worldMatrixTran;
    dataPtr->view = viewMatrixTran;
    dataPtr->projection = projectionMatrixTran;
